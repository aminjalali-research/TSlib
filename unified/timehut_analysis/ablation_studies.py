...
class TimeHUTAblationFramework:
    ...
    def __init__(self, base_dir: str = None, results_dir: str = None):
        ...
        self.results_dir = Path(results_dir) if results_dir else Path("/home/amin/TSlib/unified/timehut_results")
...
def main():
    ...
    if args.design:
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        output_file = f"/home/amin/TSlib/unified/timehut_results/ablations/ablation_design_{timestamp}.json"
